...
class SignupControllerWidget extends ConsumerStatefulWidget {
  final bool isAnonymousConversion;
  const SignupControllerWidget({super.key, this.isAnonymousConversion = false});

  @override
  ConsumerState<SignupControllerWidget> createState() =>
      _SignupControllerWidgetState();
}

class _SignupControllerWidgetState
    extends ConsumerState<SignupControllerWidget> {
        ...
        child: Column(
          children: [
            ...
            AuthGradientButtonWidget(
              buttonText: widget.isAnonymousConversion
                  ? translate(context, 'upgrade_body')
                  : translate(context, 'signup_body'),
              onTap: () async {
