...
class _MarketPageState extends ConsumerState {
  ...
  Widget build(BuildContext context) {
                                ...
                                child: ListTile(
                                  ...
                                  return;
                                      ...
                                      try {
                                        ...
                                        // Initialize Stripe payment sheet (simplified)
                                        /* await Stripe.instance.initPaymentSheet(
                                    paymentIntentClientSecret:
                                        paymentIntent['clientSecret'],
                                    merchantDisplayName: 'Smart Prep',
                                  );
    ...
    /* final userInfo = ref.watch(
      getUserInfoOnlineProvider(user.userDetails!.uid),
    );
    ...
    final questionSetsStream = ref
        ...
        return Scaffold(
      appBar: AppBar(title: const Text('Question Set Marketplace')),
      body: userInfo.when(
        data: (onlineUserInfo) {
          return Column(
            children: [
                          ...
                          child: ListTile(
                            ...
                            trailing: ElevatedButton(
                              onPressed: () async {
                                ...
                                try {
                                  await ref
                                      .read(marketRemoteRepositoryProvider)
                                      .purchaseQuestionSetFromMarket(
                                        set.id,
                                        set.points,
                                        onlineUserInfo.userId,
                                      );
                                  // Initialize Stripe payment sheet (simplified)
                                  /* await Stripe.instance.initPaymentSheet(
                                    paymentIntentClientSecret:
